...
public class DemoConsumerWithCooperativeReassignment {
    private static final Logger logger = LoggerFactory.getLogger(DemoConsumerWithCooperativeReassignment.class.getSimpleName());
    public static void main(String[] args) {
        ...
        //use CooperativeStickyAssignor for cooperative rebalancing
